...
\label{sec:org655231f}

\begin{frame}[label={sec:org445b797}]{Volatility is measured with the conditional variance}
\begin{itemize}
...
\begin{frame}[label={sec:orge9b7cac}]{Characteristics of volatility (1)}
\begin{enumerate}
...
\caption{\label{fig:org66a9518}
Percentage Change in the NYSE U.S.100 stock price index}
\end{figure}
\end{enumerate}
\end{frame}

\begin{frame}[label={sec:org3935447}]{Characteristics of volatility (2)}
\begin{enumerate}
...
\caption{\label{fig:orgfc37718}
Annualized Growth Rate of Real GDP}
\end{figure}
\end{enumerate}
\end{frame}

\begin{frame}[label={sec:org395d0e1}]{Characteristics of volatility (3)}
\begin{enumerate}
...
\label{sec:org0150574}

\begin{frame}[label={sec:orgb38876d}]{The basic idea of building a volatility model}
...
\begin{frame}[label={sec:org7b0d5a3}]{Decompose \(r_t\) into the mean and variance equations}
...
\begin{frame}[label={sec:org9ef1f6a}]{The mean equation}
\begin{align}
...
\begin{frame}[label={sec:orgf63218d}]{The variance equation}
...
\begin{frame}[label={sec:org1fd2f68}]{The variance equation (cont'd)}
\begin{itemize}
...
\begin{frame}[label={sec:org091ce45}]{The procedure of building a volatility model}
...
\begin{frame}[label={sec:org0bf4c4a}]{Testing for the presence of ARCH effect}
...
\label{sec:orgc7f6593}

\begin{frame}[label={sec:org6d5dd12}]{The basic idea of an ARCH model}
...
\begin{frame}[label={sec:org5c06ec4}]{The ARCH(m) model}
...
\begin{frame}[label={sec:org3b1102d}]{The Properties of an ARCH Model}
\begin{itemize}
...
\begin{frame}[label={sec:org52c233e}]{The unconditional mean and variance of \(a_t\)}
...
\begin{frame}[label={sec:org828a4e9}]{The unconditional covariance of \(a_t\)}
...
\begin{frame}[label={sec:org29dbb8c}]{The kurtosis of \(a_t\)}
\begin{itemize}
...
\begin{frame}[label={sec:orgae78f4b}]{The kurtosis of \(a_t\) (cont'd)}
...
\begin{frame}[label={sec:orga160847}]{The conditional mean}
\begin{itemize}
...
\begin{frame}[label={sec:orgf6b706f}]{The conditional variance}
\begin{itemize}
...
\label{sec:org13f9c95}

\begin{frame}[label={sec:orgbd1e39e}]{The definition of the likelihood function}
...
\begin{frame}[label={sec:orgea3cce9}]{The joint density for \(a_1, \ldots, a_T\) given the parameter vector \(\mathbf{\alpha}\)}
\begin{itemize}
...
\begin{frame}[label={sec:org0814384}]{The conditional likelihood function}
...
\begin{frame}[label={sec:org48f9e86}]{The conditional log-likelihood function}
...
\begin{frame}[label={sec:org40fa0d9}]{Order determination}
\begin{itemize}
...
\begin{frame}[label={sec:orgff52ba7}]{Why using the PACF?}
...
\begin{frame}[label={sec:org5abdafe}]{Alternative distribution assumptions of \(\epsilon_t\)}
\begin{itemize}
...
\label{sec:orgb776779}

\begin{frame}[label={sec:org9b34623}]{Model checking}
...
\begin{frame}[label={sec:org415520a}]{Forecasting}
...
\label{sec:org5823b7e}

\begin{frame}[label={sec:orgab7fcca}]{An ARCH model for the monthly log returns of Intel stock}
...
\begin{frame}[label={sec:org4477461}]{Model checking}
