...
\label{sec:org38ab533}

\begin{frame}[label={sec:org966a674}]{Volatility is measured with the conditional variance}
\begin{itemize}
...
\begin{frame}[label={sec:orgb61346f}]{Characteristics of volatility (1)}
\begin{enumerate}
...
\caption{\label{fig:orge43fd86}
Percentage Change in the NYSE U.S.100 stock price index}
\end{figure}
\end{enumerate}
\end{frame}

\begin{frame}[label={sec:orgc694d10}]{Characteristics of volatility (2)}
\begin{enumerate}
...
\caption{\label{fig:org6b3df5d}
Annualized Growth Rate of Real GDP}
\end{figure}
\end{enumerate}
\end{frame}

\begin{frame}[label={sec:org9604e8d}]{Characteristics of volatility (3)}
\begin{enumerate}
...
\label{sec:org4dd1663}

\begin{frame}[label={sec:orgf87fff6}]{The basic idea of building a volatility model}
...
\begin{frame}[label={sec:orgc0195c5}]{Decompose \(r_t\) into the mean and variance equations}
...
\begin{frame}[label={sec:orgc1d7492}]{The mean equation}
\begin{align}
...
\begin{frame}[label={sec:org4b23d65}]{The variance equation}
...
\begin{frame}[label={sec:org7596c44}]{The variance equation (cont'd)}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2b1d31}]{The procedure of building a volatility model}
...
\begin{frame}[label={sec:org903f838}]{Testing for the presence of ARCH effect}
...
\label{sec:org52eda22}

\begin{frame}[label={sec:orga446ca3}]{The basic idea of an ARCH model}
...
\begin{frame}[label={sec:org3df0ba1}]{The ARCH(m) model}
...
\begin{frame}[label={sec:org8ee907c}]{The Properties of an ARCH Model}
\begin{itemize}
...
\begin{frame}[label={sec:orgd020c80}]{The unconditional mean and variance of \(a_t\)}
...
\begin{frame}[label={sec:org6468bac}]{The unconditional covariance of \(a_t\)}
...
\begin{frame}[label={sec:orga0c85c3}]{The kurtosis of \(a_t\)}
\begin{itemize}
...
\begin{frame}[label={sec:orge86c2d5}]{The kurtosis of \(a_t\) (cont'd)}
...
\begin{frame}[label={sec:orgbf81c21}]{The conditional mean}
\begin{itemize}
...
\begin{frame}[label={sec:org0c2d803}]{The conditional variance}
\begin{itemize}
...
\label{sec:org38738f1}

\begin{frame}[label={sec:orgbb94bf4}]{The definition of the likelihood function}
...
\begin{frame}[label={sec:orgbf0d51e}]{The joint density for \(a_1, \ldots, a_T\) given the parameter vector \(\mathbf{\alpha}\)}
\begin{itemize}
...
\begin{frame}[label={sec:orgc404b98}]{The conditional likelihood function}
...
\begin{frame}[label={sec:orge50b929}]{The conditional log-likelihood function}
...
\begin{frame}[label={sec:org2074cbf}]{Order determination}
\begin{itemize}
...
\begin{frame}[label={sec:orgcfe1ba4}]{Why using the PACF?}
...
\begin{frame}[label={sec:org8af01f0}]{Alternative distribution assumptions of \(\epsilon_t\)}
\begin{itemize}
...
\label{sec:org430091a}

\begin{frame}[label={sec:org3524e92}]{Model checking}
...
\begin{frame}[label={sec:orgf50c503}]{Forecasting}
...
\label{sec:orgbdaec5f}

\begin{frame}[label={sec:orge403625}]{An ARCH model for the monthly log returns of Intel stock}
...
\begin{frame}[label={sec:org3f7ad05}]{Model checking}
